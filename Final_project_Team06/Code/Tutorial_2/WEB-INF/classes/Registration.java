...
public class Registration extends HttpServlet {
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "<h3>Street</h3></td><td><input type='text' name='streetCust' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"
				+ "<h3>City</h3></td><td><input type='text' name='cityCust' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"	
				+ "<h3>State</h3></td><td><input type='text' name='stateCust' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"	
				+ "<h3>Zip</h3></td><td><input type='text' name='zipCust' value='' class='input' required></input>"
				+ "</td></tr><tr><td>"					
