         ...
         {  
           response.setContentType("text/html");
			...
			if (user.getUsertype().equalsIgnoreCase("retailer")){
					pw.print("<form method='post' action='UpdateCategoryDetails'>");
					pw.print("<label >Choose one of the following actions:</label>");
					pw.print("<select id='productAction' name='productAction'>");
					pw.print("<option value='Add'>Add Product</option>");
					pw.print("<option value='Update'>Update Product</option>");
					pw.print("<option value='Delete'>Delete Product</option>");
					pw.print("</select>");
			...
			if (user.getUsertype().equalsIgnoreCase("manager")){
					pw.print("<form method='post' action='ManagerRoles'>");
					pw.print("<label >Mangers Actions</label>");
					pw.print("<select id='manageractions' name='manageractions'>");
					pw.print("<option value='createUser'>Create user</option>");
					pw.print("<option value='updateOrder'>Update User Order</option>");
					//pw.print("<option value='deleteOrder'>Delete user Order</option>");
					//pw.print("<option value='addOrder'>Add user Order</option>");
					pw.print("<option value='showOrder'>Show user orders</option>");
					pw.print("</select>");
					pw.print("<input type='submit' name='submit' class='btnbuy'>");
					pw.print("</tr></form>");
				}
