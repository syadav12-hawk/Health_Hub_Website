		...
		pw.print("</td></tr>");		
                ...
                pw.print("</td></tr><table>");
  				...
  				pw.print("<table><tr></tr><tr></tr><tr><td> Review Rating: </td>");
					...
					pw.print("<tr>");/////
					pw.print("<td> Retailer Store ID(Street Name): </td>");
					...
					pw.print("<tr>");/////
					pw.print("<td> State of Retailer: </td>");
					...
					pw.print("<tr>");////
						...
						pw.print("<td><select name='prodSale'>");
					...
					pw.print("<tr>");////
					pw.print("<td>Enter your User Name: </td>");
					pw.print("<td> <input type='text' name='userName'> </td>");
			        pw.print("</tr>");	
