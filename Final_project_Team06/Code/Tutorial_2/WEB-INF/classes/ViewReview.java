        ...
        {           
			...
			else
			{
				...
				for (Review r : hm.get(productName)) 
					...
					System.out.println(r.getProdSale());
					System.out.println(r.getZipcode());
					System.out.println(r.getState());
					System.out.println(r.getRetailercity());
					System.out.println(r.getStoreId());
					System.out.println(r.getProductName());
					System.out.println(r.getUserName());
					System.out.println(r.getProductType());
					System.out.println(r.getProductMaker());
					...
					System.out.println(r.getReviewText());
						...
						System.out.println(r.getProductprice());
						pw.print("<td>" +price+ "</td>");
						pw.print("</tr>");
						pw.print("<tr>");
