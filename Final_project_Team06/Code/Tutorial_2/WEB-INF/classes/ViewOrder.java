		...
		if(request.getParameter("Order")!=null && request.getParameter("Order").equals("ViewOrder"))
		{
			...
			{	
				...
				{	
					...
					pw.print("<td>Services availed:</td>");
					pw.print("<td>Charges:</td>");
					pw.print("<td>Appoinment Date:</td>");
					...
					for (OrderPayment oi : orderPayments.get(orderId)) 
					{
						...
						pw.print("<td>"+oi.getOrderId()+".</td><td>"+oi.getUserName()+"</td><td>"+oi.getOrderName()+"</td><td>Price: "+oi.getOrderPrice()+
						         "</td><td>"+oi.getDeliveryDate()+"</td><td>"+oi.getDeliveryMode()+"</td>");
						pw.print("<td><input type='submit' name='Order' value='CancelOrder' class='btnbuy'></td>");
						pw.print("</tr>");
					
					}
					pw.print("</table>");
					pw.print("<h4 style='color:red'>Note : You can't cancel order on or after 5 days before delivery date </h4>");
				}
				else
				{
