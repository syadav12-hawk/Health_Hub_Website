...
@WebServlet("/MEDICAREList")

public class MEDICAREList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<a style='font-size: 24px;'>"+name+" Medicare</a>");
		...
		if (CategoryName == null)	
		{
			for (String key : hm.keySet()) { 
				...
				if (product.getProdType().equals("MEDICARE")){
	...
	public void show_doctors(String name,PrintWriter pw,HashMap<String,Product> hm){
		...
		pw.print("<li id='item'><img src='images/medicares/"+product.getImage()+"' alt='' /></li>");///////
		...
		pw.print("<li><form method='post' action='Cart'>" +
				...
				"<input type='hidden' name='type' value='Medicares'>"+
